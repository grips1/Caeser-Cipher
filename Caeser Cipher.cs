    ...
    class NewBaseType
    {
        public static void Main()
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                if (Alphabet_lowercase.Contains(Message[i])) // Subroutine for lowercase letters
                {   
                ...
                else if ((Alphabet_uppercase.Contains(Message[i]))) // Subroutine for uppercase letters
                {
